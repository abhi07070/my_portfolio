            ...
            <Fade left>
              <div className="left-side">
                <h1 className="container-h">
                  Hi all, I'm{" "}
                  <Typed strings={strings} typeSpeed={80} backSpeed={60} loop />
                </h1>
                <p className="container-p">
                  I'm passionate Full Stack web developer having an experience
                  of web applications with React.js, Express.js and Nodejs
                  Frameworks.
                </p>
                ...
                <a
                  className="btn social-link-animation"
                  href="https://docs.google.com/document/d/11KdYECM5bUSG8EFgg5suXZBlAkjYj-IvJyKw5FieUpk/edit?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <span>
